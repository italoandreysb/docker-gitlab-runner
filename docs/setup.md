...
Detailed step-by-step to configure and use GitLab + GitLab Runner.

## Configuration

1. Create `.env` and adjust the variables:
...
Once GitLab is up, you need a registration token to connect the runner.
